...
<main role="main">
  ...
  <div class="container mt-4">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card">
         <img src="images/buket roz.jpg" class="img-fluid pic1" alt="">
      ...
      <div class="col-md-4">
        <div class="card">
         <img src="images/Sinie zvety.jpg" class="img-fluid pic2" alt="">
         <div class="card-body text-center">
...
<div class="container mt-4">
  <div class="row">
    ...
    <div class="col-md-6">
       <div class="card">
         <img src="images/buket.jpg"  class="img-fluid pic3" alt="">
         <div class="card-body">
    ...
    <div class="container mt-4">
      ...
      <h3 class="text-center">Add Class/Remove Class/Switch Class</h3>
       ...
       <div class="col-md-6">
        <div class="card">
          <div class="div">
            <p>Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Она путь имеет если бросил текст взобравшись свою на берегу. Мир подзаголовок взобравшись диких свой обеспечивает они вскоре, над предупреждал пустился.  
              </p>
          </div>
           <div class="card-body">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="animate">
          <p>Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Рыбными, всеми правилами. Пор диких своих осталось меня коварный которой инициал рот над заголовок бросил решила, продолжил назад? Родного, выйти.
            </p>
        </div>
        <div class="card-body">
