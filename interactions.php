...
<main role="main">
  <div class="container mt-4">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="images/latte.jpg" class="img-fluid drag" alt="">
      </div>
      <div class="col-md-4">
        <img src="images/kava.jpg" class="img-fluid drag" alt="">
      </div>
      <div class="col-md-4">
        <img src="images/tort.JPG" class="img-fluid drag" alt="">
      </div>
    </div>
  </div>
  <div class="container mt-4">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card resize">
          <img src="images/kava.jpg" class="card-img-top" alt="">
          <div class="card-body">
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolor quas deserunt in nemo, necessitatibus ipsa iure? Ipsum repellat, cumque soluta vero temporibus suscipit sunt, optio, distinctio unde doloribus dolorem.</p>
            </div>
        </div>
      </div>
    </div>
